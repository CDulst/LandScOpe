...
const App = () => {
  return useObserver(() => (
    ...
    <div className = "nav__wrapper home">
        ...
        <li className = "nav__item"><a class = "nav__link" href = "D" alt = "" >HOME</a></li>
    </div>
    <div class = "nav__wrapper explore">
        <img src="assets/svg/seperator.svg" alt=""/>
        <li className = "nav__item"><a class = "nav__link" href = "D" alt = "" >EXPLORE</a></li>
    </div>
    <div class = "nav__wrapper collection">
        <img src="assets/svg/seperator.svg" alt=""/>
        <li className = "nav__item"><a class = "nav__link" href = "D" alt = "" >COLLECTION</a></li>
    </div>
    </ul>
</div>
...
<a href="D" class = "account__link"><img class = "account__img" class  src="assets/svg/account-icon.svg" alt=""/></a>
</div>
<div className = "account__wrapper settings__wrapper">
  ...
  <section className = "post__by">
    ...
    <img className = "postby__image" src="assets/svg/account-icon.svg" alt=""/>
    <div className = "postby__wrapper">
    <p className = "postby__name"> Casey Dulst </p>
    <p className = "postby__title">A bewildered spirit</p>
  ...
  <img className = "arrow" src="assets/svg/arrowleft.svg" alt=""/>
  <img className = "arrow" src="assets/svg/arrowright.svg" alt=""/>
  </div>
  <div className = "nature__wrapper">
  <p className = "naturelife"> NATURE LIFE </p>
  <div className = "tags__wrapper">
  <div className = "tag__wrapper">
  <img className = "tag__image" src="assets/svg/tag.svg" alt=""/>
  <p className = "tag__para"> mist </p>
  </div>
  <div className = "tag__wrapper">
    <img className = "tag__image"  src="assets/svg/tag.svg" alt=""/>
    <p className = "tag__para"> trees </p>
    </div>
    <div className = "tag__wrapper">
      <img className = "tag__image"  src="assets/svg/tag.svg" alt=""/>
      <p className = "tag__para"> sunrise </p>
      </div>
  </div>
  </div>
  </section>
  ...
  <h3 className = " cm__title comments__title"> <span class = "comment__number">2</span> Comments </h3>
